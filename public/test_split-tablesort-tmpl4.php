...
<tbody id="datalist_ot">
  {{#each messages}}
<tr class="sort" data-id="{{id}}" data-datdep="{{daenth}}" data-heudep="{{hhenth}}" data-datfin="{{dalvth}}" data-heufin="{{hhlvth}}" draggable="true">
<?php echo $ot_tmpl3 ;?>
</tr>
  {{/each}}
</tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group">
            <label for="recipient-name" class="control-label">Date d'enlèvement:</label>
            <input type="text" class="form-control" id="recipient-name"
                disabled="disabled" value="{{datdep}}">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="control-label">Heure d'enlèvement:</label>
            <input type="text" class="form-control" id="recipient-name"
                disabled="disabled" value="{{heudep}}">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="control-label">Date de livraison:</label>
            <input type="text" class="form-control" id="recipient-name"
                disabled="disabled" value="{{datfin}}">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="control-label">Heure de livraison:</label>
            <input type="text" class="form-control" id="recipient-name"
